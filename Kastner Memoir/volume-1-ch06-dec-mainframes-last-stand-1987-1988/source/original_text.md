...
> Archived from: MASTER-EBOOK-ASSEMBLED-v4.md (Chapter 6: Digital Equipment Corporation — The Mainframe's Last Stand (1987-1988))
...
|-----------|--------|-----------|
| **Importance** | high | The chapter documents firsthand the founding of the TPC — a benchmark body whose standards shaped enterprise server procurement for decades — and the covert competitive intelligence operation that exposed the SNA Tax, materially affecting IBM's market position. |
| **Relevance** | high | Central to the history of OLTP benchmarking, enterprise minicomputer marketing, and the transition from mainframe to minicomputer to x86 server architectures in the late 1980s and early 1990s. |
| **Prescience** | high | Kastner's 1987 Yankee Group report predicted mainframe displacement by multiprocessor Intel 386 systems in the early 1990s, which proved accurate; he also foresaw that x86 would displace the VAX architecture DEC was promoting — a prediction confirmed within four years. |

### Prescience Detail


**Prediction 1:** Yankee Group report central prediction
- **Claimed:** Moore's Law was meeting economics of departmental transaction processing; multiprocessor Intel 386 systems were appearing; mainframe cost-per-transaction advantage was evaporating.
- **Year:** 1987
- **Confidence at time:** high

**Prediction 2:** Mainframe displacement timeline prediction
- **Claimed:** Mainframe displacement was 'not a matter of whether but when — and when was the early 1990s.'
- **Year:** 1987
- **Confidence at time:** high

**Prediction 3:** x86 vs. VAX displacement prediction
- **Claimed:** The war that would define the 1990s was x86-versus-everything-else; DEC beat IBM's mainframe pricing in OLTP; within four years x86 servers would beat DEC's VAX pricing in the same argument.
- **Year:** 1988
- **Confidence at time:** high

**Prediction 4:** 1987 prediction of Intel 386 multiprocessor servers
- **Claimed:** Kastner's Yankee Group report stated multiprocessor Intel 386 systems were 'appearing on the horizon'; by 1988 DECtp launch those systems were already arriving.
- **Year:** 1987
- **Confidence at time:** high
...
|--------|------|--------|-----------|
| Digital Equipment Corporation | company | acquired | Compaq (1998), then HP |
| DEC | company | acquired | Compaq (1998), then HP |
| Peter S. Kastner | person | active |  |
| IBM | company | active |  |
| Yankee Group | firm | acquired | 451 Research (2013) |
| Stratus Computer | company | active |  |
| Aberdeen Group | firm | acquired | Harte-Hanks (2001), then Aberdeen Group LLC |
| Aberdeen Transaction Services | firm | dissolved |  |
| Cullinet | company | acquired | Computer Associates (1989) |
| Groupe Bull | company | active |  |
| Compaq | company | acquired | HP (2002) |
| John Cullinane | person | unknown |  |
| John Logan | person | unknown |  |
| Omri Serlin | person | unknown |  |
| Bill Steul | person | unknown |  |
| Richard Case | person | unknown |  |
| Jack Smith | person | unknown |  |
| Ken Olsen | person | unknown |  |
| Edgar Codd | person | unknown |  |
| Christopher Date | person | unknown |  |
| Prime Computer | company | acquired | Computervision (1992) |
| PHI Computer Services | company | unknown |  |
| AICPA | institution | active |  |
| DEC Corporate Systems Group | company | dissolved |  |
| MIS Week | institution | dissolved |  |

### Technologies Referenced (24)

| Technology | Category | Vendor | Lifecycle (at study) | Lifecycle (current) |
|------------|----------|--------|---------------------|---------------------|
| DEC VAX Architecture | platform | Digital Equipment Corporation | mature | legacy-end-of-life |
| VAX Architecture | platform | Digital Equipment Corporation | mature | legacy-end-of-life |
| VMS | platform | Digital Equipment Corporation | mature | legacy-supported |
| DEC Rdb | application | Digital Equipment Corporation | growing | legacy-supported |
| DECtp (DEC Transaction Processing) | platform | Digital Equipment Corporation | emerging | legacy-end-of-life |
| Online Transaction Processing (OLTP) | framework |  | mature | active |
| IBM 3090 Mainframe | platform | IBM | mature | legacy-end-of-life |
| IBM SNA (Systems Network Architecture) | protocol | IBM | mature | legacy-end-of-life |
| IBM DB2 | application | IBM | growing | active |
| IBM 3270 Terminal | platform | IBM | mature | legacy-end-of-life |
| CICS (Customer Information Control System) | application | IBM | mature | active |
| SNA (Systems Network Architecture) | protocol | IBM | mature | legacy-end-of-life |
| Debit-Credit Benchmark | framework |  | mature | legacy-end-of-life |
| TPC-A Benchmark | framework | Transaction Processing Performance Council | emerging | legacy-end-of-life |
| TPC-B Benchmark | framework | Transaction Processing Performance Council | emerging | legacy-end-of-life |
| TPC-C Benchmark | framework | Transaction Processing Performance Council | emerging | legacy-supported |
| TPC-H Benchmark | framework | Transaction Processing Performance Council | emerging | active |
| RAMP-C Benchmark | framework | Stratus/IBM | mature | legacy-end-of-life |
| Bull DPS 7000 | platform | Groupe Bull | mature | legacy-end-of-life |
| Intel 386 (x86) | platform | Intel | growing | legacy-end-of-life |
| Moore's Law | framework |  | mature | active |
| VTAM (Virtual Telecommunications Access Method) | platform | IBM | mature | legacy-supported |
| VAX 8200 | platform | Digital Equipment Corporation | growing | legacy-end-of-life |
| VAX-11/780 | platform | Digital Equipment Corporation | declining | legacy-end-of-life |

### Observation Summary

- Total observations: 95
- By type: personal-recollection: 40, market-data: 22, topic-insight: 18, expert-opinion: 11, viability-prediction: 4
