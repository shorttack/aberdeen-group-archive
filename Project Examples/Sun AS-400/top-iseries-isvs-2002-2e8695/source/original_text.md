...
> Archived from: Top-iSeries-ISVs-10.pdf
...
|-----------|--------|-----------|
| **Importance** | medium | Inventory of key iSeries channel partners Sun would need to recruit; defining operational artifact of the RAMP engagement. |
| **Relevance** | low | Partner list is historical; most named ISVs have been acquired or transformed. |
| **Prescience** | not-applicable | Directory of contemporaneous facts, not predictions. |
...
- By type: partner-profile: 17, actual-outcome: 2
