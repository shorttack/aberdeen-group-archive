...
**Last updated:** 2026-06-13 AM (§11u-cont Pass B SHIPPED end-to-end. All 4 commits + tag + GitHub Release v1.6.1 + Zenodo webhook fired. Pre-flight audit found 4 transcripts with `prescience='[DEFERRED]'` — schema violation, must reconcile before next release. Today's remaining work: build `Pete_Only/` directory.)
