...
- **`kastner-jrl-trends-1999-pk-responses-f4c5a4`** (TRENDS-1-14.DOC, 1999) — Aberdeen-era memo: a list of 9 trends for 1999 compiled by **JRL** (John R. Logan, Aberdeen Group co-founder, partner, and board chairman) followed by detailed **"PK Response"** annotations from Peter Kastner. Trends cover application integration, Y2K remediation, Y2K contingency planning, Intel banner year, #1-vendor share gains, telecom switching, Sun ascendancy, Windows 2000 slow adoption, post-Y2K e-commerce. **Kastner adds three extension trends**: (10) who owns security, (11) the year of the object, and (12) **computing as a utility service / ISPs** — directly foreshadowing cloud computing by ~7 years (AWS 2006). Primary-source Kastner thinking artifact in long-form annotation style with multiple validated forecasts (Sun ascendancy, Office 2000 delay, Win2K slow uptake, IT epiphany before 2000, security cross-cutting concern).
