...
Webarchive / HTML files reviewed during Kastner archive processing but not ingested as distinct study packages or quote rows. Each entry documents why.

## Batch 7 (2026-04-19)

| # | File | Date | Publication | Reason Skipped |
|---|---|---|---|---|
| 1 | Apple unveils smaller music player (iPod mini) | 2004-01-06 | MarketWatch (Rex Crum) | **Mirror of existing coverage** at row 340 / seq 177 ("Apple looks to lower iPod price"). Both Kastner quotes already captured. No new attribution work. |
| 6 | Application Infrastructure BPM SOA Thought Leaders directory | undated (~2008-2009) | BTQuarterly | **Biographical directory listing only** — "Peter S. Kastner, VP and Research Director, Aberdeen Group." No Kastner quotation, no analytical content. Captured implicitly by existing Aberdeen employer-record. |

Both skipped files retained in `/batch_20260419_quotes7/` workspace for provenance.

## Batch 8 (2026-04-19)

| # | File | Date | Publication | Reason Skipped |
|---|---|---|---|---|
| 1 | Ballmer: State want to Destroy Windows (WinInsider repost) | 2002-03-05 | WinInsider (reposting NewsFactor) | **Mirror** of existing seq 101 NewsFactor coverage. Both quote-bearing passages already at rows 184, 185. The misattributed row 417 was re-attributed from seq 195 to seq 101 as part of Batch 8 cleanup. No new Kastner quotes. |

All other nine Batch 8 files produced re-attributions and/or new quote rows — none fully skipped. File 5 (Grantsdale/Alderwood) was a blogspot repost of what is clearly a TechNewsWorld-originated article (June 2004 chipset launch); attribution recorded as TechNewsWorld with publication date 2004-06-21 since the blog version is a garbled machine-translation-quality republication.
...
|---|---|---|---|---|
| 1 | DC-Velocity-February-2003-Newsworthy | 2003-02 | DC Velocity (web) | **Duplicate** of File 2 (print edition of same article). Processed once via File 2 as row 1003 / seq 583. |
| 3 | deal-architect-Haagen-Dazs-Light | 2005-04 | dealarchitect.typepad.com (Vinnie Mirchandani) | **Mention-only**: Kastner named in a list of "ex-Aberdeen" analysts ("Brian Sommer, Peter Kastner, Chris Selland — ex Aberdeen"). No direct Kastner quotation. No new row. |
| 5 | DEFENSE-INDUSTRY-GEARING-UP Free Preview NYT | 1981-03-20 | The New York Times | **Duplicate** of File 6 (same article, paywall preview shell vs. full PDF). Used only to confirm URL (nyti.ms/29KTHvw). |
| 6 | DEFENSE-INDUSTRY-GEARING-UP NYT PDF | 1981-03-20 | The New York Times (Pamela G. Hollie) | **Attribution fix**, not new rows. Rows 469 & 470 (seq 196) were previously mis-labeled "IBM Lands Navy Supercomputer Deal / E-Commerce Times / Keith Regan / 2004-07-27"; re-attributed to "Defense Industry Gearing Up / NYT / Pamela G. Hollie / 1981-03-20". Row 470's broken Quote-1 fragment replaced with Quote 2 (Weapons/Moscow cruise-missile quote). |
| 7 | Dell-3Q-Net-Up-21-Forbes.com | 2003-11-14 | Forbes.com | **Duplicate quotes** already captured in seq 196 mis-blob (rows 471, 488: "bread and butter", "consumer electronics signal"). Known cleanup debt — re-attribution of those rows from "IBM Lands Navy Supercomputer Deal" to Forbes will be handled in a future seq-196 split pass. |
| 8 | Dell-Debuts-64-bit-Itanium-Server | (2004) | ServerWatch | **Duplicate quotes** already in seq 196 rows 472-474 ("4-way Itanium", "Dell seldom builds products that its customers said they won't buy", "Itanium growing market acceptance"). Known cleanup debt. |
| 9 | Dell-Drops-Windows-From-Some-PCs | (2002) | PC World | **Duplicate quote** at seq 196 row 475 ("install that alternate operating system"). Known cleanup debt. |
| 10 | Dell-gets-a-lift-following-growth-report | (2003) | MarketWatch | **Duplicate quote** at seq 196 row 476 ("very good quarter, again, for Dell"). Known cleanup debt. |
| 11 | Dell-launches-personal-and-workgroup-printers | (2003) | Computerworld | **Duplicate quotes** at seq 196 rows 477-479 ("first foray into printers", "acknowledged leader in the printing business", "most innovative technology…most users' needs"). Known cleanup debt. |

Files producing new/modified rows in Batch 14:
- **File 2** → row 1003 / seq 583 (DC Velocity "Soft growth seen for software")
...
## Batch 27 skips (2026-04-19)

### Files skipped (sibling-property syndications, no-Kastner sources, duplicate)

- **F2** (Intel-s-Grantsdale-Kick-the-Tires-First-2, EnterpriseITPlanet) — same-author `internet.com` sibling-property republication of the canonical **F1 InternetNews.com / Michael Singer / 2004-06-17 'Intel's Grantsdale: Kick the Tires First'** (new seq 667). Identical byline (Michael Singer), identical Kastner quote text on 915/925 chipset integrated graphics vs discrete boards. Per corpus convention, downstream same-company syndications within the internet.com publishing family do not get distinct rows. SKIP.
- **F3** (Intel-s-New-Pentiums-Server-Center-Network-Computing-3, Network Computing / Darrell Dunn / 2004-02-03) — CMP-sibling syndication of **seq 666** (InformationWeek / Darrell Dunn / 2004-02-02 'Intel Unveils Next-Generation Pentium 4 Processors') established in Batch 26. Same author, same publisher family (CMP/United Business Media), same Prescott P4 quote corpus ("top-of-the-line part at such a low price", 300mm wafer advantage, "99.9% of consumer users don't need 64-bit parts today"). Publication date one day later in the sibling weekly. SKIP as CMP-sibling syndication duplicate.
- **F6** (Internet-Networking-s-New-World-Order-Washington-Technology-1996) — Washington Technology 1996-08-29 feature 'Internet: Networking's New World Order' on federal-sector Internet/intranet adoption. Full-text scan shows **zero Kastner mentions** and zero Aberdeen Group mentions. Peripheral-topic coverage without Kastner content. SKIP.
- **F8** (iTKO-and-Aberdeen-Group-Webinar-SOA-Governance) — iTKO.com promotional landing page (2007-02-27) announcing a joint iTKO/Aberdeen webinar on SOA governance. Marketing-only page with no article body and no direct Kastner quote text — only speaker blurb and registration CTA. Per Batch 4 gated-whitepaper and webinar-landing-page precedent, promotional pages without quote text are not row candidates. SKIP.
- **F9** (Janal-Kalis-Radio-Weblog-2004) — Janal Kalis Radio Weblog 2004-02-01 blog post excerpting MIT Technology Review / David H. Freedman / Feb 2004 'Gadgets in the Superchip Age'. Kastner quotes present (cellphone multi-frequency architecture, "drive a new cycle of cell-phone buying", "HAL from 2001 but a lot closer") **already captured at seq 181 rows 345-347** under the headline 'The Incredible Shrinking Gadget' (MIT Technology Review / Freedman / 2004-01-30). Same article content, different published headline (print vs online). SKIP as duplicate of seq 181. **Headline-review candidate flagged:** 'Gadgets in the Superchip Age' may be the canonical MIT Technology Review print title; a future headline-normalization pass could update seq 181's recorded headline from 'The Incredible Shrinking Gadget' (possibly an editorial/online variant) to 'Gadgets in the Superchip Age'.

### Batch 27 CSV delta

- **12 new rows appended** (row_ids 1058-1069) across 5 new canonical seqs (667-671):
  - **seq 667** (F1) InternetNews.com / Michael Singer / 2004-06-17 'Intel's Grantsdale: Kick the Tires First' — 1 row on Intel's 915/925 chipsets and integrated 3D graphics displacing discrete boards for low-end workstations. Distinct from existing **seq 454** (TechNewsWorld 2004-06-21 Grantsdale coverage, different author, distinct quote).
  - **seq 668** (F4) Wi-Fi Planet / Erin Joyce / 2003-03-12 'Intel's New Wireless Platform: Centrino' — **4-row internal series** on Centrino launch: "biggest announcement of the year" + 20-22% → 30% notebook share forecast + road-warrior battery life + "lighting a match" platform-branding. Third-party Centrino launch piece; distinct from **seq 121** (Kastner's own InformationWeek column on Centrino) and **seq 654** (US News / Rae-Dupree 2003-05-12 'Intel bets big on making wireless', reassigned in Batch 25).
  - **seq 669** (F5) Intelligent Enterprise / Susana Schwartz & Mark Leon / 2004-05 — 1 row on open-source databases recommended for Java/Web apps and vertical ISVs, with Aberdeen market-sizing (embedded $400M, mobile/desktop $150M, high-perf cache $100M). NEW corpus topic — first Kastner open-source-database row.
  - **seq 670** (F7) Wi-Fi Planet / Ed Sutherland / 2003-11-04 'Is the Wi-Fi End Nigh?' — **5-row internal series** on Aberdeen's 'Urban Wi-Fi Crash of 2004' report: Starbucks-latte interference scenario + 300k-400k APs/month shipment rate + "end of the Wi-Fi world is imminent" + 3-channel 802.11b/g technical root cause + hardware replacement cycle required. Distinct from **seq 621** (Inc. magazine / Greenleaf / 2003-10-23 — same Aberdeen report, different publication, different quote corpus).
  - **seq 671** (F10) Washington Times / Mark Kellner / 2009-01-14 'Jobs health stirs tech world, and with reason' — 1 row. **First Facebook-sourced Kastner quote in the corpus** (blog-post content-type): Kastner's real-time Facebook status "watching Apple stock crater as poor Steve Jobs takes an LOA," quoted by the Washington Times technology blogger on the day of Steve Jobs's medical leave announcement.
- **5 new canonical seqs**: 667, 668, 669, 670, 671. With 2 internal multi-row series (seq 668 = 4 rows, seq 670 = 5 rows) and 3 single-row seqs, 12 source-paragraph-level quotes distribute across 5 canonical article seqs.
...
**First Facebook-sourced corpus entry (seq 671)** — Batch 27 introduces the first known corpus row whose source-of-quote is a Kastner Facebook status (as re-quoted by a legitimate publication). Content-type is assigned `blog-post` consistent with the Washington Times blog context; the Facebook-status sourcing is documented in immediate_context. This expands the corpus's captured-medium range to include social-media attribution channels.

**Aberdeen 'Urban Wi-Fi Crash of 2004' cross-publication corpus** — With Batch 27 adding F7 (Wi-Fi Planet, 5 rows at seq 670) alongside existing **seq 621** (Inc. magazine, Greenleaf), the corpus now has 2 independent publications covering Kastner's same Aberdeen research report, with 6+ total quote rows. This is among the most thoroughly documented Aberdeen reports in the corpus by cross-publication coverage.
...
## Batch 30 skips (2026-04-20)

### Files skipped

- **Oracle-And-Dell-Take-Aim-At-Midsize-Businesses-Linux-Pipeline-News-Oracle-And-Dell-Take-Aim-At-Midsize-Businesses.webarchive** (InformationWeek / Linux Pipeline / Larry Greenemeier / 2004-04-07 — informationweek.com/news/software/linux/showArticle.jhtml?articleID=1) — InformationWeek Linux Pipeline republication of the canonical **Network Computing / Server Center / Larry Greenemeier / 2004-04-07 'Oracle And Dell Take Aim At Midsize Businesses'** ingested in Batch 28 as study `oracle-and-dell-take-aim-at-midsize-busi-770ea6`. Same reporter, same date, same article body, identical Kastner quote (Oracle Standard Edition One endorsement as attractive SMB Linux-on-Dell package). Per corpus convention (skill §9), same-company syndications (CMP Media / TechWeb Business Technology Network) are logged and processed only at first instance. SKIP as CMP cross-property syndication duplicate.
- **PC-Refresh-or-Refurb-7.webarchive** (Nation's Building News / nbnnews.com/NBN/textonly/2003-07-21/printall.html / 2003-07-21) — Syndication roundup of the canonical **SmallBusinessComputing.com / biztools/article.php/2235731 'Refresh or Refurb?'** ingested in this batch as study `pc-refresh-or-refurb-smb-computing-6-37f090`. The NBN print-all page bundles multiple articles including an abridged excerpt of the SmallBusinessComputing Kastner-quote sequence (Windows XP SP1 stability, Aberdeen-as-case-study refresh, "crank up the planning" advice). Per corpus convention, same-article republications are logged and processed only at first instance. SKIP as syndication duplicate.
- **PC-Replacement-Survey-One-Size-Fits-None-8.webarchive** (InformationWeek print-version / informationweek.com/shared/printableArticle.jhtml;jsessionid=... / 0 bytes extracted) — Empty webarchive, 0 bytes of body text. This URL is the `;jsessionid=` print-version variant of the canonical **InformationWeek / showArticle.jhtml?articleID=17000198 / Peter Kastner / 2003-12-23 'PC Replacement Survey: One Size Fits None'** ingested in this batch as study `pc-replacement-survey-one-size-fits-none-73e2e0`. No extractable content to record independently. SKIP as empty / print-variant duplicate.


---

## Batch 31 skips (2026-04-20)

### Files skipped

- **Rebate-Roulette-PC-World-7.webarchive** (pcworld.com/article/114150/rebate_roulette.html) — Extracted webarchive body is **zero bytes**; full-text scan produced **zero Kastner mentions** and **zero Aberdeen Group mentions**. The Safari plist archive captured only the empty outer shell with no article content. No Kastner material to record independently. SKIP as empty / no-content webarchive.
- **Rebates-discount-shopping-8.pdf** (CouponChief via discountshopping site; PDF extracted as `parsed.Rebates-discount-shopping-8.txt`) — Byte-identical **syndication duplicate** of the canonical **Chatham Journal Weekly / Gary Gray / 2005-06-26 'Rebates: Savings or scam?'** ingested in this batch as study `rebates-savings-or-scam-chatham-journal--4bf5c2`. Same author (Gary Gray, CouponChief.com), same four-step consumer-rebate survival guide, identical Kastner 40/40/20 quote ("only 40% of consumers submit rebates they are entitled to, 40% submit the rebate and successfully get a check, and 20% have problems"), identical $1B→$4B 1999-2003 market-growth statistic. The PDF appears to be a later CouponChief-site reprint of the 2005 Chatham column. Per corpus convention (skill §9), same-article republications are logged and processed only at first instance. SKIP as Gary Gray / CouponChief syndication duplicate.


---

## Batch 32 skips (2026-04-20)

### Files skipped

- **Refresh-or-Refurb-2003-4.webarchive** (smallbusinesscomputing.com/testdrive/article.php/2235731) — **URL-variant duplicate** of the canonical **SmallBusinessComputing.com / biztools/article.php/2235731 'Refresh or Refurb?'** ingested in Batch 30 as study `pc-refresh-or-refurb-smb-computing-6-37f090`. Same article ID `2235731`, published under two SmallBusinessComputing site sections (/biztools/ and /testdrive/), with identical Kastner Windows XP SP1 stability quote and identical Greg Sullivan / Microsoft Windows division paragraph. Per corpus convention (skill §9), same-article republications at different URL paths are logged and processed only at first instance. SKIP as URL-variant syndication duplicate.
- **Refresh-or-Refurb-WinPlanet-Windows-Software-Reviews-3.webarchive** (winplanet.com/article/1890-.htm) — **Syndication duplicate** of the canonical **SmallBusinessComputing.com 'Refresh or Refurb?'** (Batch 30 study `pc-refresh-or-refurb-smb-computing-6-37f090`). Verified identical lede ("much of the IT news today highlights this fall's release of Microsoft Office 2003..."), identical Kastner Windows XP SP1 stability quote ("Windows XP Professional Service Pack 1 is out in the field and working well indeed. No stability problems here."), identical Greg Sullivan paragraph. WinPlanet is a sibling internet.com / WebMediaBrands publication of SmallBusinessComputing. Per skill §9 same-publisher-family syndications are logged and processed only at first instance. SKIP as WebMediaBrands-sibling syndication duplicate.
- **Refresh-or-Refurb-Nation-s-Building-News-Online-for-July-21-2003-2.webarchive** (nbnnews.com/NBN/issues/2003-07-21/bnc2c.html) — **Syndication duplicate** of the canonical **SmallBusinessComputing.com 'Refresh or Refurb?'** (Batch 30 study `pc-refresh-or-refurb-smb-computing-6-37f090`). Condensed NBN version of the same article with identical Kastner Windows XP SP1 quote, identical Greg Sullivan paragraph, identical January-2004 Windows 98/SE EOL framing. NBN `/printall/` variant of the same issue was already skipped as Batch 30. Per skill §9 same-article republications are logged and processed only at first instance. SKIP as NBN syndication duplicate.
- **Rebates-Savings-or-Scam-owistut.webarchive** (aaands.com/article/Rebates_Savings_or_Scam_49541_ecommerce_article.html) — **Derivative/republication** of the canonical **Chatham Journal Weekly / Gary Gray / 2005-06-26 'Rebates: Savings or scam?'** ingested in Batch 31 as study `rebates-savings-or-scam-chatham-journal--4bf5c2`. Same title "Rebates: Savings or scam?", identical Kastner 40/40/20 stat ("only 40% of consumers submit rebates they are entitled to, 40% submit the rebate and successfully get a check, and 20% have problems"), identical $1B→$4B 1999-2003 market-size line. The aaands.com version is reshuffled into first-person consumer-blog voice and strips the Gary Gray attribution, but the body content, statistics, and structure derive from Gray's Chatham column. Per skill §9 same-article republications are logged and processed only at first instance. SKIP as Gary Gray / CouponChief content-aggregator republication.


---

## Batch 33 skips (2026-04-20)

### Files skipped

- **Servoy-SAAS-Platform-10.webarchive** (docstoc.com) — Document-listing/aggregator page on docstoc.com for a Servoy SaaS platform white paper. The extracted webarchive body produced **zero Kastner mentions** and **zero Aberdeen Group mentions**. Docstoc was a document-hosting site (shut down 2015) and this page is a document-directory listing, not a Kastner-cited article. No Kastner content to archive. SKIP as zero-Kastner aggregator page.


---

## Batch 34 skips (2026-04-20)

### Files skipped

- **Seven-ways-to-prepare-for-the-economic-upturn-Networking-InfoWorld-p2.webarchive** (infoworld.com/d/networking/seven-ways-prepare-economic-upturn-956?page=0,1) — **Page 2 of 3** of the canonical **InfoWorld / Dan Tynan / 2004-02-13 'Seven Ways to Prepare for the Economic Upturn'** ingested in this batch as study `seven-ways-to-prepare-for-the-economic-u-0a7d35`. The `?page=0,1` URL is InfoWorld's pagination parameter for page 2 of the same article (Sarbanes-Oxley compliance, closing security gap, consolidation, and the COBOL retirement Kastner quote). Per multi-page article rule (skill §9), URL variants `?page=0,1` / `?page=0,2` of the same article are merged into a single study — the page 2 content (including Kastner's COBOL quote) is preserved in the canonical study's raw-text file. SKIP as multi-page article merged.
- **Seven-ways-to-prepare-for-the-economic-upturn-Networking-InfoWorld-p3-2.webarchive** (infoworld.com/d/networking/seven-ways-prepare-economic-upturn-956?page=0,2) — **Page 3 of 3** of the canonical **InfoWorld / Dan Tynan / 2004-02-13 'Seven Ways to Prepare for the Economic Upturn'** ingested in this batch as study `seven-ways-to-prepare-for-the-economic-u-0a7d35`. The `?page=0,2` URL is page 3 of the same article (retooling for the knowledge economy, and the outsourcing/offshoring-watch section with Kastner's "two or three years down the road, rapid wage inflation in India is likely to erode the economic benefits" quote). Per multi-page article rule (skill §9), merged into the canonical study along with the p2 content. SKIP as multi-page article merged.
- **Snap-Appliance-revises-its-Linux-OS-with-NDMP-S2S-iSCSI-8.webarchive** (linuxdevices.com/news/NS5383514567.html) — **Press-release syndication duplicate** of the canonical **Computerworld Australia (IDG) / 2004-12-07 'Snap Appliance Launches New Release of its Unified Software Platform — GuardianOS v3.1'** ingested in this batch as study `snap-appliance-launches-new-release-of-i-373ab7`. Both articles run the same Adaptec/Snap Appliance GuardianOS v3.1 press release (announced Dec 7 2004) with the identical Kastner quote: "Snap Appliance's S2S v2 is a full featured 'replication for the masses' solution that will give enterprises the opportunity to protect and easily move data without the significant investment or complexity that was required in the past." Same release text, same Kastner endorsement, different IT-trade-press publisher. Per skill §9, press-release syndications across two publications covering the same vendor announcement are logged and processed only at first instance. SKIP as Adaptec/Snap press-release syndication duplicate.
- **SOA-adoption-eats-up-40-percent-of-IT-resources-News-Software-ZDNet-Asia-11.webarchive** (zdnetasia.com/news/software/0,39044164,39375799,00.htm) — **CNET Networks cross-property syndication** of the canonical **silicon.com / Andy McCue / 2006-07-14 'SOA adoption eats up 40 per cent of IT resources'** ingested in this batch as study `soa-adoption-eats-up-40-per-cent-of-it-r-d0cf12`. Both articles are authored by Andy McCue (ZDNet Asia version labeled "By Andy McCue, Special to ZDNet Asia"), with identical structure: 40% integration-budget opener, 90% SOA adoption claim, large-enterprise-$1B concentration, same two Kastner quotes (technology-step-forward + 40%-IT-budget-integration), and the same three-tier framework (SOA light / Enterprise SOA / SOA ERP). ZDNet Asia republished three days later (Jul 17 2006) after the silicon.com original (Jul 14 2006); silicon.com and ZDNet Asia were both CNET Networks properties in 2006. Per skill §9, same-article cross-property syndications within a publisher group are logged and processed only at first instance. SKIP as CNET Networks cross-property syndication duplicate.


---

## Batch 35 notes (2026-04-20)

Batch 10 ("webarchives letter S and T") — no skips. All 8 files produced studies.

### Syndication candidate evaluated and KEPT as distinct studies

- **Sun-Micro-slammed-as-quarterly-report-disappoints-MarketWatch.webarchive** (marketwatch.com/story/sun-micro-slammed-as-quarterly-report-disappoints) and
...
## Batch 40 notes (2026-04-24)

Batch 15 ("webarchives — Macworld/eWEEK/Computerworld/Transmeta block") — 10 files provided, 9 processed, 1 skip.

### Skipped sources

- **Transmeta-Gets-Truly-Tiny-PC-World-7.webarchive** (pcworld.com/article/114089/transmeta_gets_truly_tiny) — **IDG News Service syndication** of the identical Gillian Law story also published at Computerworld the same day (2004-01-05). Story byline "Gillian Law, IDG News Service" at both outlets; identical Kastner quote about Transmeta TM5800 performance concerns and HP TC100 tablet. Per skill §9, same-wire-service syndication is processed only at first instance. The canonical version is ingested as study `transmeta-crusoe-tm5700-tm5900-computerw-455262` from the Computerworld URL.

### Processed 9 studies

All 9 were unique URLs; 8 contain named Kastner citations. One (Business Insider "Computer Dating 1960s" by Aimee Groth, 2011-07-10) has no Kastner voice — processed as a `topic-analysis` retrospective on IBM-1400-era Operation Match / Project TACT (direct precursor of modern online dating) curated in Kastner's personal archive for historical-computing topic value.

Notable content: **Jim Dalrymple / Macworld 2004-12-30** year-in-review with Kastner's "90nm wall was industry-wide" framing for Apple's unmet 3GHz G5 promise (presaged WWDC 2005 Intel-transition by six months); **Ian Betteridge / eWEEK 2005-04-29** Tiger launch with Kastner/Vericours citing Symantec ISTR ratio 37/1,403 Apple vulnerabilities H2 2004 and predicting Apple attacks would grow with market share; **LA Times editorial / UCLA bioter site 2003-04-02** on SARS with Kastner's "electronics to Christmas toys" supply-chain-disruption prediction (validated 17 years later by COVID-19); **Carly Suppa / Computerworld AU 2002-08-13** InfiniBand feature with Kastner's "will replace TCP/IP" server-interconnect prediction (substantively validated by NVIDIA Mellanox 2019 and AI-training cluster dominance 2022-2026); **Douglas Hayward / Computing UK 1996-10-30** with Kastner 3-year predictions (browser-as-client-equality — fully validated; Novell decline — fully validated; Corel WordPerfect Java — failed) plus unique 1973 Chase Manhattan Y2K-noncompliant-code personal admission; **Gillian Law / IDG News Service 2004-01-05** Transmeta TM5700/TM5900 launch with Kastner's "not good enough for many of today's applications" performance critique (validated by Transmeta's 2009 dissolution); **John Foley / InformationWeek Issue 575 1996-04-15** with Kastner defending database category after Informix -28% one-day drop (correct on Oracle, wrong on Sybase/Informix individually); **eWEEK staff 2003-10-27** summarizing Kastner/Aberdeen "Urban Wi-Fi Crash of 2004" report predicting interference gridlock (thesis validated for 2.4GHz congestion 2007-2010, crash-timing overstated).

## Batch 41 notes (2026-04-24)

Batch 16 ("webarchives — USA Today/InformationWeek/InternetNews/NewsFactor/Vitria/Warranty Week block") — 13 files provided, 11 processed, 2 skips.

### Skipped sources

- **Videoconferencing-Boost-10.webarchive** (informationweek.com/680/80iuvid.htm;jsessionid=PERIUSNMMCLVGQSNDLOSKH0CJUNN2JVN) — **Duplicate capture** of the same canonical InformationWeek Issue 680 (1998-05-04) Mary E. Thyfault "Videoconferencing Boost" article on Intel TeamStation. Identical content to `Videoconferencing-Boost-9.webarchive` aside from session-ID URL parameters and rotated sidebar promo links. Per skill §9, same-URL variant captures (different jsessionid query strings, identical canonical path `/680/80iuvid.htm`) are processed only at first instance. The canonical article is ingested as study `informationweek-videoconferencing-boost--b62ff4`.
- **Vendors-users-plan-standard-InfiniBand-drivers-for-Linux-Network-World-5.webarchive** (networkworld.com/news/2004/0617iband.html) — **No Kastner citation and no Aberdeen reference**. Jennifer Mears Network World story on the OpenIB Alliance launch (2004-06-17) features quotes from Steve Woods (MCNC Grid Computing) and Allyson Klein (Intel) but does not cite Kastner or any Aberdeen analyst. Skipped as out-of-scope for the Kastner-author archive (no Kastner content); InfiniBand topic is amply covered by other studies in the corpus (Carly Suppa Computerworld AU 2002-08-13 in batch 15; Aberdeen InfiniBand Connectivity Demand and Outlook 2002 in kastner-author/).

### Processed 11 studies

All 11 contain distinct Kastner citations. Notable content:

- **USA Today / Kevin Maney 2004-09-21** Mac-vs-PC security column with Kastner cited as "analyst at consulting firm Vericours" (career datapoint — Kastner affiliated with Vericours late 2004) saying Mac switching costs are "huge and potentially career-threatening for most CIOs."
- **USA Today / Kevin Maney 2004-04-21** Microsoft patents column calculating $9.5M per Microsoft patent in 2003; Kastner defends Microsoft Research as underappreciated (the only batch-16 piece where Kastner is back at "Aberdeen Group").
- **USA Today / Reuters (uncredited) 2003-05-30** PC-music-deals article with Kastner predicting every major PC vendor would offer music service by Q4 2003 holiday season — broadly validated.
- **USA Today / Reuters (Kenneth Li) 2004-04-07** small-form-factor PC piece with Kastner's "next form factor battles being fought in the living room" framing — directionally correct but won by streaming sticks/consoles, not PCs.
- **InternetNews / Clint Boulton 2004-06-08** VERITAS Itanium-Linux extension with Kastner's "400 applications certified on Itanium" datapoint — factual but Itanium ultimately defeated by AMD64.
- **InformationWeek / David Joachim 2001-09-01 [REVIEW date]** post-Wyly proxy-fight CA piece with Kastner rebutting the narrative that customer-facing changes were Wyly-caused: "CA continually tweaks its sales and support organization and I certainly don't consider it to be a result of the Wyly thing at all." Date inferred from Wyly proxy-fight aftermath context.
- **Electronic News (Australia) / Ry Crozier 2003-05-14** SARS-driven videoconferencing surge with the Russ Craig + Peter Kastner joint quote on China's "no-second-source dependence" — a 2003 articulation of the supply-chain-concentration thesis fully validated by COVID-19 (2020) and US-China decoupling (2018-2025).
- **InformationWeek / Mary E. Thyfault Issue 680 1998-05-04** Intel TeamStation room videoconferencing system with Kastner's prescient "this technology will be fundamental to communications in the 21st century" prediction — triumphantly validated by Zoom/Teams.
- **NewsFactor / David Garrett 2006-11-03** Vista deployment cadence with Kastner's three-year hardware-lifecycle "cadence" model placing Vista full-deployment in 2010 (refuted — enterprises skipped to Windows 7); XP retail cutoff prediction for 2007 broadly correct.
- **Vitria Testimonials [archived 2009; quote era ~2007 REVIEW]** — Kastner endorsement of Vitria BPA "VP Enterprise Integration Research" career-title datapoint; SOA-stack thesis later displaced by REST/microservices.
- **Warranty Week / Eric Arnum 2003-05-12** Dell warranty analysis featuring Kastner as "EVP and chief research officer for the Consumer Digital Technology Practice at Aberdeen Group" — defines the Aberdeen PC reference model (2.4 GHz P4, 256 MB RAM, 40 GB HDD) and three-year-NBD warranty buying criteria that became enterprise procurement default through to today's Dell ProSupport / HP Care Pack / Lenovo Premier Support tiers.

## Batch 42 notes (2026-04-24)

Batch 17 ("webarchives + 2 PDFs — Washington Times/InformationWeek/InternetWeek/CUNA/E-Commerce Times/Purchasing/YouTube/Google block") — 12 files provided, 9 processed, 3 skips.

### Skipped sources

- **Will-SARS-Infect-High-Tech-8.webarchive** (cioupdate.com/news/article.php/2196551/) — **Jupitermedia cross-property syndication** of the identical Dan Orzech 2003-04-24 SARS article also published the same day at internetnews.com (same article ID 2196551). Per skill §9, cross-property syndications within the same publisher network (Jupitermedia operated InternetNews.com, CIO Update, Datamation, etc. as content-shared Web properties in 2003) are processed only at first instance. The canonical version is ingested as study `internetnews-will-sars-infect-high-tech--8569ea` from the InternetNews.com URL.
- **WebEx-Taking-Conferencing-to-the-Business-Communications-Summit-3.pdf** (Aberdeen Group profile of WebEx Communications, Inc., April 2002) — **Already archived in `kastner-author/`**. Kastner-authored Aberdeen Group profile previously ingested under at least three slugs: `2002-webex--taking-conferencing-to-the-summit-05f195`, `2002-webex-taking-conferencing-to-the-business-communic-85e330`, and `webex--taking-conferencing-to-the-busine-5b8109`. Skipped as duplicate of an existing kastner-author study in this archive.
- **Why-you-need-to-replace-those-Windows-98-and-NT-machines-6.pdf** (InternetWeek, May 5, 2003) — **Already archived in `kastner-author/`**. Kastner-authored InternetWeek column previously ingested under slug `why-you-need-to-replace-those-windows-98-and-nt-ma-9b9622`. Skipped as duplicate of an existing kastner-author study in this archive.

### Processed 9 studies

All 9 contain distinct Kastner citations. The flagship items are: **(a)** the **Washington Times / Mark A. Kellner 2009-07-13** Chrome-OS announcement column — earliest dated public Kastner attribution to Scott-Page (Westport MA technology research firm) in the corpus, with Kastner identified as "chief research officer at Scott-Page" and "co-founder of the noted Aberdeen Group"; this is a **NEW career datapoint** for the post-Aberdeen / pre-Scott-Page-Associates 2009 affiliation period. **(b)** **InternetNews / Dan Orzech 2003-04-24 SARS article** — primary source of Kastner's pandemic supply-chain framework (multi-sourcing outside Asia, logistics-war-room CEO reporting, China second-largest-PC-consumer recession risk, Sun cancelled April 7 Shanghai launch + Intel cancelled IDF Taiwan/Beijing) — a 17-year-early articulation of the playbook universalized in 2020 COVID-19 response. **(c)** **CUNA / Jan Garkey 2004-04-19 "Win the Rebate Runaround"** — earliest dated instance in our corpus of Kastner's canonical 40/40/20 rebate-redemption statistic (40% don't submit, 40% successfully redeem, 20% have problems), predating the BusinessWeek/Grow December 2005 piece by ~20 months. **(d)** **InformationWeek Issue 730 / Stuart J. Johnston + Mary Hayes 1999-04-19 Windows 2000 Datacenter Server piece** with Kastner's "call me when it's ready" IT-DM framing and IBM-mainframe-95%-boost-per-processor scalability benchmark for NT critique — plus Aberdeen IT-DM survey (n=240, January 1999) deployment intent data. **(e)** **E-Commerce Times / Lou Hirsh 2002-06-25** Interactive TV failure piece with Kastner's prescient "ITV must be built into TV sets" prediction — fully validated by Smart TV ascendance (>80% penetration by 2020). **(f)** **Purchasing Magazine 2003-11-20** with Kastner's pushback on the disputed BEA Q3-2003 15.4% IT-spend growth figure ("not being reflected in IT budgets or revenues") plus first-stage Centrino/Pentium-M notice. **(g)** **InformationWeek / WebEx Enterprise Edition 2003-01-17** with Kastner endorsing site-license cost-allocation model — a precursor of standard SaaS enterprise pricing. **(h)** **Google Profile artifact 2009** — personal-archive provenance datapoint linking Kastner identities (pskastner@gmail.com, vanity URL `/profiles/pskastner`, numeric `/profiles/110552360138965462985`, YouTube channel `catalina588`, Picasa handle `pskastner`). **(i)** **YouTube transcript artifact 2008-09-23** — Intel-published "Industry Analyst Discusses Impact of Intel vPro Technology" video (URL `Qtr3rqJAzUI`) featuring Kastner on vPro TCO benefits for Core 2 vPro / Centrino 2 vPro; vendor-published analyst-relations video in the late-Aberdeen / early-Scott-Page transition window (skill §13.1 type: transcript).


## Batch 43 notes (2026-04-24)

Batch 18 ("webarchives + Aberdeen PDFs + PPTs + DOC — IBM-MS NT clusters / Itanium / IDC-Wired / AMD 64-bit visionaries / YouTube anti-theft / YouTube Intel security / Aberdeen Secure SOA / SOA Governance / SOA Middleware / Modernizing Legacy / Testing SOA / Retail BI / SIPP speech / TRENDS-1-14") — 14 files provided, 13 processed, 1 skip.

### Skipped sources

- **YouTube-Is-Intel-a-security-company-6.webarchive** (`http://www.youtube.com/watch?v=AxAu49YtGyY`, channelintel) — **No body content / Kastner appears as tag only.** The captured webarchive contains only YouTube page metadata (chrome navigation, video description, sidebar links) with no transcript or analyst-quote content. Kastner does not appear in the description text or tag list for this specific video; only the parallel `xx70-aU3sZo` video ("Industry Analysts Discuss Benefits of Intel Anti-Theft Technology") includes "peter kastner" in its tag list and was processed as study `youtube-channelintel-anti-theft-tech-200-73a093`. Per skill §9 (no extractable Kastner content), skipped.

### Processed 13 studies (3 kastner-author + 10 other-authors)

**kastner-author/ (3):**

- **`aberdeen-ra-soa-management-governance-20-ff6a2c`** (RA_SOAGov_3944_PKRS_040307a-8.pdf, 2007-03) — Aberdeen Group benchmark report co-authored by **Peter S. Kastner and Russ Craig (PKRS)** on SOA Management and Governance. Survey of 200+ companies (Nov 2006-Jan 2007); 33% of Best-in-Class have >2yr SOA experience; 68% of Best-in-Class achieving positive SOA ROI vs. 77% of overall sample yet to see payback; 80%+ of Best-in-Class have automated SOA operations and governance. Kastner/Craig **long-term cost-collar warning**: "inefficiencies caused by lack of SOA management and governance lower IT performance, raise current operating costs, and collar IT with long-term software maintenance costs that will endure for decades" — fully validated by 2020s platform-engineering rationale. Author signature is removed from the extracted PDF cover but filename convention (`PKRS_040307a`) confirms PKRS co-authorship; matches Russ Craig's other co-authored Aberdeen reports (e.g., `2003-sars-electronics-supply-chain-ec0375`).

- **`kastner-sipp-pc-lifecycle-dynamics-2003-4395fd`** (SIPP_speech_Florida_06_30_03-13.ppt, 2003-06-30) — Kastner-authored 25-slide speech at SIPP Florida conference titled **"PC Lifecycle Dynamics"**. Cover slide: "Peter Kastner, Executive Vice President and Chief Research Officer, AberdeenGroup" — **EVP/CRO title confirmation as of June 2003**. Aberdeen Best Practices ranked by ROI (highest to lowest): standard images on common platforms, automated backup/restore/healing, software distribution, device synchronization, remote control, thin clients. Includes Communications, Financial Services, and Beverages industry case studies and TCO analytics maturity audience polls.

- **`kastner-jrl-trends-1999-pk-responses-f4c5a4`** (TRENDS-1-14.DOC, 1999) — Aberdeen-era memo: a list of 9 trends for 1999 compiled by **JRL** (presumed John R. Lewis or similar Aberdeen colleague) followed by detailed **"PK Response"** annotations from Peter Kastner. Trends cover application integration, Y2K remediation, Y2K contingency planning, Intel banner year, #1-vendor share gains, telecom switching, Sun ascendancy, Windows 2000 slow adoption, post-Y2K e-commerce. **Kastner adds three extension trends**: (10) who owns security, (11) the year of the object, and (12) **computing as a utility service / ISPs** — directly foreshadowing cloud computing by ~7 years (AWS 2006). Primary-source Kastner thinking artifact in long-form annotation style with multiple validated forecasts (Sun ascendancy, Office 2000 delay, Win2K slow uptake, IT epiphany before 2000, security cross-cutting concern).

**other-authors/ (10):**

- **`informationweek-ibm-ms-nt-clusters-1999-8c5b45`** (1999-05-21, InformationWeek staff) — IBM "Cornhusker" 8-node Windows NT cluster demo at TechEd '99 with Kastner as **"research director and executive VP at the Aberdeen Group"** (1999 title datapoint) noting two-node MSCS limits constraining enterprise NT customers.
- **`cnet-shankland-ibm-itanium-x450-2003-c91608`** (2003-04-29, Stephen Shankland/CNET) — IBM x450 Itanium 2 server launch with **multiple Kastner predictions all substantially validated**: Itanium taking material market share at high end; Xeon revenue dominance for 5+ years; IBM forced to ship Itanium fast after announcing Opteron; HP "betting the company on Itanium" (later proved a multi-decade albatross; Itanium discontinued 2021).
- **`wired-idc-tech-bucks-hack-threats-2002-e6375d`** (2002-12, Wired staff) — IDC's 2003 IT-spending forecast (6%) with Kastner counter-forecast at 3% calling 6% "totally unsustainable in this economy" (Kastner closer to actual ~2.9% outcome).
- **`amd-industry-analyst-visionaries-64bit-2-7a191f`** (2003-09, AMD publication) — AMD-curated industry-analyst quote collection ahead of AMD64/Opteron/Athlon 64 launch with Kastner's **"mainstream desktops by 2010"** prediction on full 64-bit RAM addressability — substantially validated by Windows 7 (2009) making x86-64 the desktop default.
- **`youtube-channelintel-anti-theft-tech-200-73a093`** (2008-09, channelintel/Intel) — Documentary trace of Kastner appearing in tag list of Intel Anti-Theft Technology promotional video (no transcript in webarchive; importance/relevance/prescience all rated low).
- **`aberdeen-ra-secure-soa-benchmark-2006-605d67`** (2006-07, Stacey Quandt/Aberdeen) — Secure SOA Benchmark Report by Aberdeen Research Director, Security Solutions and Services. **Aberdeen colleague**, not Kastner-authored; routed to other-authors per skill §14 routing rule.
- **`aberdeen-ra-soa-middleware-2007-68f39b`** (2007-07, Perry Donham/Aberdeen) — SOA Middleware Takes the Lead. Donham titled "Director, Enterprise Integration Research" as of July 2007.
- **`aberdeen-ra-modernizing-legacy-2007-52a27a`** (2007-06, Perry Donham/Aberdeen) — Modernizing Legacy Applications: Maximizing the Investment.
- **`aberdeen-rb-testing-soa-web-apps-2007-e2096f`** (2007-08, Perry Donham/Aberdeen) — Testing SOA and Web Services Applications brief; Donham now titled "Director, Enterprise Applications Research" — **title change from Enterprise Integration Research between July and August 2007** captured as a research-director-organization datapoint.
- **`aberdeen-retail-bi-benchmark-survey-2006-aa440e`** (2006-03, Paula Rosenblum/Aberdeen) — Retail BI Benchmark Studies hypothesis-and-survey deck. **Aberdeen colleague**, not Kastner-authored; only 2 incidental Kastner mentions in 32 slides; routed to other-authors per skill §14.
