...
> Archived from: wiki/themes/kastner-prescience-market-rollup.md
...
|-----------|--------|-----------|
| **Importance** | high | Sets precedent for archive-as-instrument: first study in the Kastner archive that demonstrates how the archive itself can be used for rigorous research. Defines the share-of-prescience attribution formula (lead x contrarian x specificity / 250) used for future archive analyses. |
...
- By type: topic-insight: 63, market-data: 20, viability-prediction: 15
