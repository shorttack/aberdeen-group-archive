...
## Kastner Archive Longitudinal Study — Prompt Document v2
...
**Claim.** TPC-A drove a 79% improvement in K$/TPS-A from January 1990 to March 1992, and continued improving through 1993. This was the most dramatic benchmark-driven price/performance compression in enterprise computing history to that date.
...
| Slug | Title | Date |
|---|---|---|
| `study-tandem-tr-85-2-debitcredit-1985-ca207a` | Tandem Debit/Credit TR 85-2 | 1985 |
| `study-1992-tpc-benchmarks-vp-ed0e0d` | Better Performance and Lower Prices Through TPC Benchmarks | 1992-03-15 |
| `1992-tpc-benchmarks-vp-745fa1` | (same document, second slug — dedupe flag) | 1992-03-15 |
| `study-dtj-v03-01-tp-and-fault-tolerant-1991-cf078c` | DTJ v03-01 TP and Fault Tolerant | 1991 |
