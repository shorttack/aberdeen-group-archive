...
## Kastner Archive Longitudinal Study — Prompt Document v4
...
> **License:** CC-BY-4.0
> **v4 changes:** Added §9.1c memoir chapter assembly guide (ch05/ch06/ch07 study_ids, Westwood Midnight Ambush OBS refs, specsmanship bridge, WORKLIST §21 tagging gap note, DuckDB pull query).
