...
| Domain | OLTP-benchmark-methodology |
| License | CC-BY-4.0 |
...
Walt Kohler & Yun-Ping Hsu, DEC HPS/OLTP Systems Performance Analysis Group (1987). DEC Proposed Debit-Credit Benchmark Guidelines (Kohler/Hsu, Dec 1987).
