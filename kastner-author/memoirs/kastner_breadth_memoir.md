...
> **Note on numbers:** This memoir reflects the Aberdeen-Group Archive as of **v1.4, May 5, 2026** — a corpus of 915 unique studies and 17,819 observations. The archive has since grown (v1.6, May 31, 2026: 1,434 studies, 23,605 observations). All quantitative claims in this document — mention counts, technology totals, vendor distributions, decade tables, thematic rollups — are intentionally preserved at their v1.4 values, because the memoir is *about* the archive's state on that date. For current archive shape, see `wiki/README.md` in the live wiki.
