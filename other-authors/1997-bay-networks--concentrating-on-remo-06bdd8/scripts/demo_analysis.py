#!/usr/bin/env python3
"""Demo analysis for: Bay Networks: Concentrating on Remote Access (Aberdeen Group, 1997)"""
import csv, os
...
def main():
    ...
    print("\nReferential integrity: PASS" if not errors else "\nINTEGRITY ERRORS: " + str(errors))
    ...
    print(f"\nPredictions: {len(preds)} | Actual outcomes: {len(outcomes)}")
