#!/usr/bin/env python3
"""
Demo analysis script for aberdeen-1995-universal-servers-rdbms-technology-next-decade
...
def main():
    ...
    print(f"=== aberdeen-1995-universal-servers-rdbms-technology-next-decade ===")
