#!/usr/bin/env python3
"""Demo analysis for aberdeen-1996-debunking-ntsmp-scalability-myth"""
import csv, os
...
for o in observations:
    ...
    if o["methodology_code"] not in code_ids:
        errors.append(f"MISSING method: {o['methodology_code']}")
...
for b in benchmarks:
    print(f"  {b['metric_name']}: {b['metric_value'][:60]}")

print("\nPrescience summary:")
print("  NT 4-way 16,000 tpmC by 1998: VERIFIED (exceeded)")
print("  Wolfpack HA clusters by 1997: VERIFIED (MSCS Q4 1997)")
print("  NT performance clusters >20K tpmC: VERIFIED (Sequent NUMA 48,793 tpmC Oct 1998)")
print("  NT mid-range dominance: VERIFIED (IDC 2002 market share data)")
