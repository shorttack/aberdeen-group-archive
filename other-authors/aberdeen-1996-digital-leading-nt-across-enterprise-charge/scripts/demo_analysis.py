#!/usr/bin/env python3
"""Demo analysis for aberdeen-1996-digital-leading-nt-across-enterprise-charge dataset."""
import csv, os
...
def main():
    ...
    print("=== Digital NT Enterprise Charge - Dataset Summary ===")
    ...
    for p in preds:
        print(f"  P: {p['metric_name'][:70]}")
    for o in outcomes:
        print(f"  O: {o['metric_name'][:70]}")
