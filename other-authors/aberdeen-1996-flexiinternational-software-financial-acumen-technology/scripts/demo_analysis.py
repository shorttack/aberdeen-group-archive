...
Study: aberdeen-1996-flexiinternational-software-financial-acumen-technology
...
def main():
    print("=" * 60)
    print(f"STUDY: aberdeen-1996-flexiinternational-software-financial-acumen-technology")
    print("=" * 60)
