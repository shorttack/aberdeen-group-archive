#!/usr/bin/env python3
"""Demo analysis for aberdeen-1996-ibm-as400-vs-microsoft-nt-server dataset."""
import os, csv
...
def main():
    ...
    print("=" * 60)
    print("DATASET: aberdeen-1996-ibm-as400-vs-microsoft-nt-server")
    print("=" * 60)
    s = studies[0]
    ...
    for b in benchmarks:
        print(f"  {b['metric_name'][:50]}: {b['metric_value'][:80]}")
    print()
