#!/usr/bin/env python3
"""Demo analysis for aberdeen-1996-khalix-financial-awareness-competitive-advantage."""
import os, csv
...
def main():
    ...
    print("=" * 60)
    print("DATASET: aberdeen-1996-khalix-financial-awareness-competitive-advantage")
    print("=" * 60)
    s = studies[0]
