#!/usr/bin/env python3
"""Demo analysis for aberdeen-1996-vpns-business-mfs-success-strategy"""
import csv, os
...
print("MFS world leadership: PARTIALLY VERIFIED (WorldCom acquisition validated; WorldCom went bankrupt 2002)")
print("VPN market trend: VERIFIED (IP/MPLS/SD-WAN VPNs are now ubiquitous)")
print("65-metro plan: LIKELY ON TRACK at time of WorldCom acquisition (Aug 1996)")
