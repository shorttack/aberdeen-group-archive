...
Study: aberdeen-1996-web-warehouses-dss-for-masses
"""
import csv, os
...
def main():
    ...
    pairs = [
        ('aberdeen-1996-web-warehouses-dss-for-masses-OBS-018',
         'aberdeen-1996-web-warehouses-dss-for-masses-OBS-019'),
        ('aberdeen-1996-web-warehouses-dss-for-masses-OBS-020',
         'aberdeen-1996-web-warehouses-dss-for-masses-OBS-021'),
    ]
    verified = 0
