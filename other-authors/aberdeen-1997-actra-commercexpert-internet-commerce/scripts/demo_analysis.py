#!/usr/bin/env python3
"""Demo analysis script for aberdeen-1997-actra-commercexpert-internet-commerce dataset."""
import csv, os
...
def main():
    ...
    print("=== Aberdeen Group: Actra CommerceXpert (1997) ===")
    print(f"Study: {studies[0]['title'][:80]}")
    print(f"Note: 1-page abstract profile ({1573} chars source)")
    ...
    print(f"Viability predictions: {len(preds)}, Actual outcomes: {len(outcomes)}")
    for p in preds:
