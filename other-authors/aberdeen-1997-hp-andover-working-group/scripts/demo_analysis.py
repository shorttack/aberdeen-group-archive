#!/usr/bin/env python3
"""Demo analysis script for aberdeen-1997-hp-andover-working-group dataset."""
import csv, os
...
def main():
    ...
    print("=== Aberdeen Group: HP Andover Working Group (1997) ===")
    ...
    print(f"Actual outcomes: {len(outcomes)} ({len(verified)} verified)")
    for p in preds:
