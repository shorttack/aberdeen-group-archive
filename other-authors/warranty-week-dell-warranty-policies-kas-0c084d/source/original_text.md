...
> Archived from: Warranty-Week-Dell-s-Warranty-Policies-12-May-2003.webarchive
...
URL: http://www.warrantyweek.com/archive/ww20030512.html

Warranty Week, Dell's Warranty Policies, 12 May 2003 
...
Dell's profits soar, company cuts costs by more than expected, reduced warranty expenses cited. 
 ...
 Copyright © 2003 Warranty Week, All Rights Reserved
...
|-----------|--------|-----------|
| **Importance** | high | Defines Aberdeen's enterprise PC reference model and warranty buying criteria — a core Kastner DCT-era framework that influenced corporate procurement standards. |
| **Relevance** | medium | Three-year-NBD warranty norm persists in enterprise PC procurement; specific 2003 Dell SKUs and pricing are dated. |
| **Prescience** | high | Kastner's three-year-minimum + NBD-on-site warranty framework remains the de-facto enterprise PC standard 20+ years later, validated by Dell ProSupport/HP Care Pack/ Lenovo Premier Support tier structures. |

### Prescience Detail


**Prediction 1:** Three-year NBD warranty norm endurance
- **Claimed:** Three-year-NBD warranty becomes enterprise-procurement default
- **Year:** 2008
...
|--------|------|--------|-----------|
| Warranty Week | company | active |  |
| Eric Arnum | person | active |  |
| Peter S. Kastner | person | active |  |
| Aberdeen Group | firm | acquired | Spiceworks Ziff Davis (2018) |
| Dell Computer Corporation | company | active | Dell Technologies (2016 brand) |
| InternetWeek | company | discontinued | CMP/UBM publication ceased 2003 |

### Technologies Referenced (6)

| Technology | Category | Vendor | Lifecycle (at study) | Lifecycle (current) |
|------------|----------|--------|---------------------|---------------------|
| Dell OptiPlex GX260 | hardware | Dell | mature | obsolete |
| Dell Dimension (consumer desktop) | hardware | Dell | mature | discontinued |
| Dell Inspiron (consumer notebook) | hardware | Dell | mature | active |
| Dell Latitude (business notebook) | hardware | Dell | mature | active |
| Intel Pentium 4 (2.4 GHz) | platform | Intel | mature | obsolete |
| Aberdeen PC Reference Model | framework | Aberdeen Group | new | obsolete |

### Observation Summary

- Total observations: 11
- By type: market-data: 8, expert-opinion: 2, viability-prediction: 1
