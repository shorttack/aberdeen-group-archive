# Kastner Aberdeen Archive — Future Work

**Last updated:** 2026-05-26
**Current ship state:** wiki `v1.5.1` (commit `23c01603`) + kw_ask.py v3 + provenance-gap system live

This is the forward-looking backlog. Items are roughly ordered by dependency and impact, not strict priority. Tag each item v1.6, v1.7, etc. when it lands.

---

## v1.6 candidates (next minor release)
...
_Owner: Pete Kastner. Updates via PR to `shorttack/aberdeen-group-archive`._
