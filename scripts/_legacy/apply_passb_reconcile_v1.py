...
Usage:
    python3 apply_passb_reconcile_v1.py                 # dry-run
    python3 apply_passb_reconcile_v1.py --commit        # write
...
def main():
    ...
    bak = MASTER.with_suffix(f".csv.bak_passb_reconcile_{ts}")
    ...
    # Audit trail
    audit = MASTER.parent / f"passb_reconcile_v1_applied_{ts}.txt"
    with open(audit, "w", encoding="utf-8") as f:
        f.write(f"Pass B reconciliation applied {ts}\n")
