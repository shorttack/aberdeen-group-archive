...
================================
Pass C v2 pre-filter: produce per-study `scoreable_obs_v4.csv` listing only
...
Schema differences from v2 (May 25 abandoned run):
  ...
  - Emits scoreable_obs_v4.csv (filename bumped to avoid confusion with v1 abandoned outputs)
  - Emits skipped_obs_v4.csv and filter_summary_v4.json (same)
  - Root audit CSV: _bucket_audit_v4.csv (filename bumped)
