#!/usr/bin/env python3
"""apply_passb_transcripts_v3.py — Pass B transcript batch apply, schema-correct.

Changes vs v2 (2026-07-25 AUTO batch, L147): the deprecated UTC-now call -> its timezone-aware replacement
