#!/usr/bin/env python3
"""
backfill_row_class_v2.py — F3b backfill / rename for _master_prescience_scores.csv

v2 (2026-07-25 AUTO batch, L103): the deprecated UTC-now call -> its timezone-aware replacement
