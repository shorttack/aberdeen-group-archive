#!/usr/bin/env python3
"""
02_build_data_layer_v3.py — Phase 2: Parquet → DuckDB (v1.5)

v3 corrections vs v2 (WORKLIST §4c — 2026-05-29):
  - Fix v_studies_by_decade + v_prescience_by_decade: previous expression
    ...
    '1990s'. New expression `(CAST(pub_year AS INTEGER) / 10) * 10 || 's'`
    casts FIRST so the / and * use DuckDB integer arithmetic, producing
    the correct decade bucket.
...
Usage:
  python3 02_build_data_layer_v3.py --wiki ~/Desktop/kastner_wiki
"""
