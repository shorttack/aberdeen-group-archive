...
v5 changes (§11q, 2026-06-02):
  - scorer_version_target string now built from _llm_helper_v2.LOCAL_MODEL
...
try:
    ...
    if (_here / "build" / "_llm_helper_v2.py").exists():
        sys.path.insert(0, str(_here / "build"))
    from _llm_helper_v2 import LOCAL_MODEL, scorer_version_target
