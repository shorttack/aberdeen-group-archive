...
Peter S. Kastner is an independent technology researcher and co-founder of Aberdeen Group, where he served as Chief Research Officer from 1988 to 2007. He holds a Ph.D. from MIT and degrees from Berkeley. Earlier in his career he was a developer at Wang and Arthur D. Little, and a marketing executive at Prime Computer, Stratus Computer, and DEC. He is based in Savannah, Georgia.

---

*Word count (body text): approximately 6,820 words.*
*Submitted May 2026 to IEEE Annals of the History of Computing.*
*Dataset DOI: 10.5281/zenodo.20245076*
*Manuscript repository: https://github.com/shorttack/aberdeen-group-archive/tree/main/submissions/ieee-annals-2026*
